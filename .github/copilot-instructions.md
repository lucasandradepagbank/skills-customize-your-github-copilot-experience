...
- **Amigável para estudantes**: Use linguagem clara e encorajadora que motiva os estudantes
 ...
 - **Sempre utilize conventional instructions**: Todas as instruções, exemplos e conteúdos devem seguir padrões convencionais de nomenclatura, estrutura e boas práticas reconhecidas.